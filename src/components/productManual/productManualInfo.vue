...
<template>
    ...
    <iframe  class="manage-main-contents" scrolling="auto" style="height:80%;" :src="link" @load="handleLoad"></iframe>
...
export default{
    ...
    beforeMount(){
        ...
        this.link = "http://" + host + "/com.ifp.ipartner/productManual/index.html"
    },
    mounted(){
