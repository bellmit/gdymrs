        ...
        <div class="manage-contents">
            <div id="firstTab">
                ...
                <div class="img1" style="display:flex;justify-content:space-between;margin-top:1%">
                    ...
                    <div>
                        <img src="../../../../static/img/policy/2012101.png"  style="width:130px;height:60px;">
                    </div>
                </div>
            <!--内容-->
            <div class="content">
                ...
                <p class="suojinP">感谢您选择光大永明人寿保险有限公司(以下简称“我公司”)的《光大永明安鑫福年金保险》产品，这是对我公司的充分信任和支持，为了让您更充分的了解条款内容，保障您的合法 权益，请仔细阅读产品条款中<span class="boldP">第十条</span>的相关免责内容，具体免责内容如下:</p>
                ...
                <p class="suojinP">发生上述第 1 项情形导致被保险人身故的，保险合同终止。若您已交足 2 年以上保险费的，
                    我公司向身故保险金受益人退还保险合同终止时的现金价值。</p>
                <p class="suojinP">发生上述第 2 至 7 项情形导致被保险人身故的，保险合同终止。我公司将于收到下列证明
                    材料后 30 日内向您退还保险合同终止时的现金价值。</p>
                <p class="suojinP">1、保险合同;</p>
                <p class="suojinP">2、您的有效身份证件。</p>
                <br><br>
                <p class="boldP suojinP">请您仔细阅读上述提示内容，并签字确认。</p>
                <br><br>
                <p class="soujinP" style="line-height:20px">&nbsp;&nbsp;&nbsp;&nbsp;投保人签字:<img :src="sign" alt="" style="border-bottom:1px solid #000;width:30px;height:30px;"> &nbsp;&nbsp;&nbsp;&nbsp;日期:</p>
