        ...
        <div class="manage-contents">
            <div id="firstTab">
                ...
                <div class="img1" style="display:flex;justify-content:space-between;margin-top:1%">
                    ...
                    <div>
                        <img src="../../../../static/img/policy/2014301.jpg"  style="width:130px;height:60px;">
                    </div>
                </div>
            <!--内容-->
            <div class="content">
                <h1>光大永明附加投保人豁免保险费终身重大疾病保险产品</h1>
                <h1>免除保险人责任确认书</h1>
                <p class="normalP">尊敬的客户，您好!</p>
                <p class="suojinP">感谢您选择光大永明人寿保险有限公司（以下简称“我公司”）的《光大永明附加投保人豁免保险费终身重大疾病保险》产品，这是对我公司的充分信任和支持，为了让您更充分的了解条款内容，保障您的合法权益，请仔细阅读条款中<b style="font-weight:bold;">第九条</b>的相关免责内容，具体免责内容如下:</p>
                <p class="suojinP boldP">第九条 责任免除</p>
                <p class="suojinP">在下列情形下被保险人身故、高度残疾或患有附加合同所列的轻症疾病、重大疾病的，我公司不承担保险责任：</p>
                <p class="suojinP">1、被保险人故意犯罪或者抗拒依法采取的刑事强制措施;</p>
                <p class="suojinP">2、被保险人自附加成立或者效力恢复之日起 2 年内自杀，但被保险人自杀时为无民事行为能力人的除外;</p>
                <p class="suojinP">3、被保险人服用、吸食或注射毒品;</p>
                <p class="suojinP">4、被保险人酒后驾驶、无合法有效驾驶证驾驶或驾驶无有效行驶证的机动车;</p>
                <p class="suojinP">5、战争、军事冲突、暴乱或武装叛乱、恐怖袭击;</p>
                <p class="suojinP">6、核爆炸、核辐射或核污染;</p>
                <p class="suojinP">7、被保险人感染艾滋病病毒或患艾滋病，但不包括【名词释义】中所列的第 31 种（由输血或输液导致的人类免疫缺陷病毒感染）、第 32 种（因职业关系和因器官移植导致的人类免疫缺陷病毒（HIV）感染）、第 94 种（因器官移植导致的人类免疫缺陷病毒（HIV）感染）;</p>
                <p class="suojinP">8、遗传性疾病、先天性畸形、变形或染色体异常;</p>
                <p class="suojinP">9、被保险人在附加合同生效（或最后复效）日之前已患有附加合同所列的轻症疾病或重大疾病。</p>
                <p class="suojinP">发生上述情形导致被保险人身故、高度残疾或患有附加合同所列的轻症疾病或重大疾病的，附加合同终止。我公司将于收到下列证明材料后 30 日内向您退还附加合同终止时的现金价值。</p>
...
<script>
    ...
    export default{
        ...
        data() {
            return {
                page_title: '光大永明附加投保人豁免保险费终身重大疾病保险产品',
