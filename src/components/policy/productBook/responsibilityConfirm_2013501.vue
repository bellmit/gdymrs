    ...
    <div id="comfirmBook">
        ...
        <div class="manage-contents">
            ...
            <div class="img1" style="display:flex;justify-content:space-between;margin-top:1%">
                ...
                <div>
                    <img src="../../../../static/img/policy/2013501.png"  style="width:130px;height:60px;">
                </div>
            </div>
                <!--内容-->
                <div class="content">
                    <h1>光大永明关爱永逸两全保险(2018 版)</h1>
                    <h1>免除保险人责任确认书</h1>
                    <p class="normalP">尊敬的客户，您好!</p>
                    <p class="suojinP">感谢您选择光大永明人寿保险有限公司(以下简称“我公司”)的《光大永明关爱永逸两全
                        保险(2018 版)》产品，这是对我公司的充分信任和支持，为了让您更充分的了解条款内容，保 障您的合法权益，请仔细阅读主险产品条款中<b style="font-weight:bold">第十条</b>的相关免责内容，具体免责内容如下:</p>
                    <p class="suojinP boldP">第十条 责任免除:</p>
                    <p class="suojinP">在下列情形下被保险人身故或高度残疾的，我们不承担保险责任:</p>
                    <p class="suojinP">1. 您对被保险人的故意杀害、故意伤害;</p>
                    <p class="suojinP">2. 被保险人故意犯罪或者抗拒依法采取的刑事强制措施;</p>
                    <p class="suojinP">3. 被保险人自本合同成立或者合同效力恢复之日起 2 年内自杀，但被保险人自杀时为无民
                        事行为能力人的除外;</p>
                    ...
                    <p class="suojinP">发生上述第 1 项情形导致被保险人身故或高度残疾的，本合同终止。若您已交足二年以上 保险费的，我们向其他权利人退还本合同终止时的现金价值。</p>
                    <p class="suojinP">发生上述第 2 至 7 项情形导致被保险人身故或高度残疾的，本合同终止。我们将于收到下 列证明材料后 30 日内向您退还本合同终止时的现金价值。</p>
...
<script>
    ...
    export default{
        ...
        data() {
            return {
                page_title: '光大永明关爱永逸保险产品计划（2018）责任免除声明书',
