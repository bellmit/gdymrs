        ...
        <div class="manage-contents">
            <div id="firstTab">
                ...
                <div class="img1" style="display:flex;justify-content:space-between;margin-top:1%">
                    ...
                    <div>
                        <img src="../../../../static/img/policy/2013401.png"  style="width:130px;height:60px;">
                    </div>
                </div>
            <!--内容-->
            <div class="content">
                ...
                <p class="suojinP">感谢您选择光大永明人寿保险有限公司(以下简称“我公司”)的《光大永明至爱家传终身
                    寿险》产品，这是对我公司的充分信任和支持，为了让您更充分的了解条款内容，保障您的合 法权益，请仔细阅读主险产品条款中第十条的相关免责内容，具体免责内容如下:</p>
                <p class="suojinP boldP">第十条 责任免除:</p>
                <p class="suojinP">在下列情形下被保险人身故或高度残疾的，我们不承担保险责任:</p>
                <p class="suojinP">1. 您对被保险人的故意杀害、故意伤害;</p>
                <p class="suojinP">2. 被保险人自本合同生效(或最后复效)之日起 2 年内自杀，但被保险人自杀时为无民事
                    行为能力人的除外;</p>
                <p class="suojinP">3. 被保险人故意自伤、故意犯罪或者抗拒依法采取的刑事强制措施;</p>
                ...
                <p class="suojinP">发生上述第 1 项情形导致被保险人身故或高度残疾的，本合同终止。若您已交足 2 年以上 保险费的，我们向其他权利人退还本合同终止时的现金价值。</p>
                <p class="suojinP">发生上述第 2-7 项情形导致被保险人身故或高度残疾的，本合同终止。我们将于收到下列 证明材料后 30 日内向您退还本合同终止时的现金价值。</p>
...
<script>
    ...
    export default{
        ...
        data() {
            return {
                page_title: '光大永明至爱家传终身寿险免除保险人责任确认书',
