        ...
        <div class="manage-contents">
            <div id="firstTab">
                ...
                <div class="img1" style="display:flex;justify-content:space-between;margin-top:1%">
                    ...
                    <div>
                        <img src="../../../../static/img/policy/2013201.png"  style="width:130px;height:60px;">
                    </div>
                </div>
            <!--内容-->
            <div class="content">
                <h1>光大永明附加无忧女性疾病保险</h1>
                <h1>免除保险人责任确认书</h1>
                <p class="normalP">尊敬的客户，您好!</p>
                <p class="suojinP">感谢您选择光大永明人寿保险有限公司(以下简称“我公司”)的《光大永明附加无忧女性
                    疾病保险》产品，这是对我公司的充分信任和支持，为了让您更充分的了解条款内容，保障您的合法权益，请仔细阅读产品条款中<b style="font-weight:bold;">第六条</b>的相关免责内容，具体免责内容如下:</p>
                <p class="suojinP boldP">第六条 责任免除</p>
                <p class="suojinP">因下列情形之一导致被保险人发生保险事故的，保险公司不承担给付保险金责任:</p>
                <p class="suojinP">1、投保人对被保险人的故意杀害、故意伤害;</p>
                <p class="suojinP">2、被保险人故意犯罪、拘捕、斗殴、自杀、自伤身体及服用、吸食或注射毒品;</p>
                ...
                <p class="suojinP">因上述情形之一导致被保险人发生附加合同约定的保险事故的，附加合同终止。除法律及
                    附加合同另有规定外，我公司将于收到下列证明材料后三十日内向您退还附加合同终止时的保 险单现金价值净额。</p>
