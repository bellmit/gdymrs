        ...
        <div class="manage-contents">
            <div id="firstTab">
                ...
                <div class="img1" style="display:flex;justify-content:space-between;margin-top:1%">
                    ...
                    <div>
                        <img src="../../../../static/img/policy/2013801.png"  style="width:130px;height:60px;">
                    </div>
                </div>
                <!--内容-->
                <div class="content">
                    <h1>光大永明附加关爱永逸重大疾病保险(2018 版)</h1>
                    <h1>免除保险人责任确认书</h1>
                    <p class="normalP">尊敬的客户，您好!</p>
                    <p class="suojinP">感谢您选择光大永明人寿保险有限公司(以下简称“我公司”)的《光大永明附加关爱永逸
                        重大疾病保险(2018 版)》产品，这是对我公司的充分信任和支持，为了让您更充分的了解条款 内容，保障您的合法权益，请仔细阅读主险产品条款中<b style="font-weight:bold;">第十条</b>的相关免责内容，具体免责内容 如下:</p>
                    <p class="suojinP boldP">第十条 责任免除:</p>
                    <p class="suojinP">
                        在下列情形下被保险人患有本附加合同约定的轻症疾病或重大疾病的，我们不承担保险责 任:</p>
                    <p class="suojinP">1. 您对被保险人的故意杀害、故意伤害;</p>
                    <p class="suojinP">2. 被保险人故意犯罪或者抗拒依法采取的刑事强制措施;</p>
                    <p class="suojinP">3. 被保险人自本附加成立或者效力恢复之日起 2 年内自杀，但被保险人自杀时为无民事行
                        为能力人的除外;</p>
                    ...
                    <p class="suojinP">8. 被保险人感染艾滋病病毒或患艾滋病，但不包括【名词释义】中所定义的第 31 种由输血
                        或输液导致的人类免疫缺陷病毒感染、第 32 种因职业关系导致的人类免疫缺陷病毒(HIV)
                        感染和第 94 种因器官移植导致的人类免疫缺陷病毒(HIV)感染;</p>
                    <p class="suojinP">9. 遗传性疾病、先天性畸形、变形或染色体异常;</p>
                    <p class="suojinP">10. 被保险人在本附加合同生效日之前已患有本附加合同所列的重大疾病。</p>
                    <p class="suojinP">发生上述第 1 项情形导致被保险人患有本附加合同约定的轻症疾病或重大疾病的，本附加 合同终止。若您已交足二年以上保险费的，我们向其他权利人退还本附加合同终止时的现金价 值。</p>
                    <p class="suojinP">发生上述第 2-10 项情形导致被保险人患有本附加合同约定的轻症疾病或重大疾病的，本附 加合同终止。我们将于收到下列证明材料后 30 日内向您退还本附加合同终止时的现金价值。</p>
                    <p class="suojinP">1. 本附加合同;</p>
...
<script>
    ...
    export default{
        ...
        data() {
            return {
                page_title: '光大永明附加关爱永逸重大疾病保险（2018版）责任免除声明书',
