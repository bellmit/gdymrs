        ...
        <div class="manage-contents">
            <div id="firstTab">
                ...
                <div class="img1" style="display:flex;justify-content:space-between;margin-top:1%">
                    ...
                    <div>
                        <img src="../../../../static/img/policy/2013301.png"  style="width:130px;height:60px;">
                    </div>
                </div>
            <!--内容-->
                <div class="content">
                    <h1>光大永明富贵人生年金保险(分红型)</h1>
                    <h1>免除保险人责任确认书</h1>
                    <p class="normalP">尊敬的客户，您好!</p>
                    <p class="suojinP">感谢您选择光大永明人寿保险有限公司(以下简称“我公司”)的《光大永明富贵人生年金
                        保险(分红型)》产品，这是对我公司的充分信任和支持，为了让您更充分的了解条款内容，保 障您的合法权益，请仔细阅读主险产品条款中<b style="font-weight:bold;">第十条</b>的相关免责内容，具体免责内容如下:</p>
                    ...
                    <p class="suojinP">3. 被保险人自本合同成立或者合同效力恢复之日起 2 年内自杀，但被保险人自杀时 为无民事行为能力人的除外;</p>
                    <p class="suojinP">4. 被保险人服用、吸食或注射 毒品;</p>
                    <p class="suojinP">5. 被保险人 酒后驾驶、 无合法有效驾驶证驾驶或驾驶 无
                        有效行驶证的 机动车;</p>
                    <p class="suojinP">6. 战争、军事冲突、暴乱或武装叛乱、恐怖袭击;</p>
                    <p class="suojinP">7. 核爆炸、核辐射或核污染。</p>
                    <p class="suojinP">发生上述第 1 项情形导致被保险人身故的，本合同终止。若您已交足 2 年以上保险费的，
                        我们向身故保险金受益人退还本合同终止时的现金价值。</p>
                    <p class="suojinP">发生上述第 2 至 7 项情形导致被保险人身故的，本合同终止。我们将于收到下列证明材
                        料后 30 日内向您退还本合同终止时的现金价值。</p>
...
<script>
    ...
    export default{
        ...
        data() {
            return {
                page_title: '光大永明富贵人生年金保险（分红型）责任免除声明书',
