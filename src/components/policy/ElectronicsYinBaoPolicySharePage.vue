	...
	<div id="content">
		...
		<div v-show="contentIsOpen">
			...
			<div class="manage-main-contents">
				<!-- <v-touch class="touch-wrapper" @swipeleft="right" @swiperight="left"> -->
				<!-- 顶部图片 -->
	    	...
	    	let requ = {
              ...
              this.deathFavoreeList.sort(compare)
				...
				if(this.$route.params.result != -1){
					//成功打开签字框
					console.log("成功打开签字框1",this.$route.params.result)
					if(this.$route.params.result == 0){
						console.log("成功打开签字框2",this.$route.params.result)
						if(this.$route.params.index != -1){
							console.log("成功打开签字框3",this.$route.params.index)
