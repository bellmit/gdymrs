...
<template>
	<div id="content">
		<Headerbtns :title = page_title>
			<div slot="left" class="back" @click="go('../list/')">
			...
			<div class="content">
				<div>
					...
					<ul>
						<li>
							<span>姓名:</span>
							<input type="text" class="underText" placeholder="请输入姓名" v-model="docTypeInfo.appntName">
						</li>
						<li>
							<span>性别:</span>
							<input type="text" class="underText" placeholder="请输入性别" v-model="docTypeInfo.appntSex">
						</li>
						<li>
							<span>年龄:</span>
							<input type="text" class="underText" placeholder="请输入年龄" v-model="docTypeInfo.appntAge">
						</li>
					</ul>
					<p>
				...
				<div class="content_1">
					...
					<div class="one">
						...
						<div class="choose">
							<div>
								<p>
									<input type="checkbox" v-model="docTypeInfo.socialInsu" @change="socialInsurance">
									A 社会保险
									(
									<input type="checkbox" v-model="docTypeInfo.socialInsuA">
									a工伤保险
									<input type="checkbox" v-model="docTypeInfo.socialInsuB">
									b社会医疗保险
									<input type="checkbox" v-model="docTypeInfo.socialInsuC">
									c社会养老保险
									)
								</p>
								<p>
									<input type="checkbox" v-model="docTypeInfo.commercialInsu" @change="commercialInsurance">
									B 商业保险
									(
									<input type="checkbox" v-model="docTypeInfo.commercialInsuA">
									a意外险
									<input type="checkbox" v-model="docTypeInfo.commercialInsuB">
									b健康险
									<input type="checkbox" v-model="docTypeInfo.commercialInsuC">
									c人寿保险
									<input type="checkbox" v-model="docTypeInfo.commercialInsuD">
									d年金保险
									)
								</p>
							</div>
							...
							<div class="choose">
								<div>
									<p>
										<input type="checkbox" v-model="docTypeInfo.insuCostA" :disabled="!docTypeInfo.commercialInsu" @change="clickinsuCost('A')">
										A 5000元以下
										<input type="checkbox" v-model="docTypeInfo.insuCostB" :disabled="!docTypeInfo.commercialInsu" @change="clickinsuCost('B')">
										B 5000-10000元以下
										<input type="checkbox" v-model="docTypeInfo.insuCostC" :disabled="!docTypeInfo.commercialInsu" @change="clickinsuCost('C')">
										C 10000-20000元以下
										<input type="checkbox" v-model="docTypeInfo.insuCostD" :disabled="!docTypeInfo.commercialInsu" @change="clickinsuCost('D')">
										D 20000-50000元以下
										<input type="checkbox" v-model="docTypeInfo.insuCostE" :disabled="!docTypeInfo.commercialInsu" @change="clickinsuCost('E')">
										E 50000元以上
									</p>
								</div>
								...
								<div class="choose">
									<div>
										<p>
											<input type="checkbox" v-model="docTypeInfo.exceedTwentyA" :disabled="!docTypeInfo.commercialInsu" @change="clickExceedTwenty('A')">
											A 超过
											<input type="checkbox" v-model="docTypeInfo.exceedTwentyB" :disabled="!docTypeInfo.commercialInsu" @change="clickExceedTwenty('B')">
											B 未超过
										</p>
									</div>
								</div>
					...
					<div class="two">
						...
						<div class="choose">
							<div>
								<p>
									<input type="checkbox" v-model="docTypeInfo.deathInsu" @change="clickSuit('death')">
									A 身故和残疾保障
									<input type="number" class="yuan" v-model="docTypeInfo.deathInsuValue">元，
									保障<input type="text" class="year" v-model="docTypeInfo.deathInsuYear">年
								</p>
								<p>
									<input type="checkbox" v-model="docTypeInfo.majorDiseaseInsu" @change="clickSuit('major')">
									B 重大疾病保障
									<input type="number" class="yuan" v-model="docTypeInfo.majorDiseaseInsuValue">元，
									保障<input type="text" class="year" v-model="docTypeInfo.majorDiseaseInsuYear">年
								</p>
								<p>
									<input type="checkbox" @change="clickSuit('medical')" v-model="docTypeInfo.medicalInsu">
									C 医疗费用保障
									<input type="number" class="yuan" v-model="docTypeInfo.medicalInsuValue">元，
									保障<input type="text" class="year" v-model="docTypeInfo.medicalInsuYear">年
								</p>
								<p>
									<input type="checkbox" @change="clickSuit('education')" v-model="docTypeInfo.educationInsu">
									D 教育金
									<input type="number" class="yuan" v-model="docTypeInfo.educationInsuValue">元，
									保障<input type="text" class="year" v-model="docTypeInfo.educationInsuYear">年
								</p>
								<p>
									<input type="checkbox" @change="clickSuit('survival')" v-model="docTypeInfo.survivalInsu">
									E 生存金返还 
									<input type="number" class="yuan" v-model="docTypeInfo.survivalInsuValue">元，
									保障<input type="text" class="year" v-model="docTypeInfo.survivalInsuYear">年
								</p>
								<p>
									<input type="checkbox" @change="clickSuit('annuity')" v-model="docTypeInfo.annuityInsu">
									F 年金/退休金收入保障 
									<input type="number" class="yuan" v-model="docTypeInfo.annuityInsuValue">元，
									保障<input type="text" class="year" v-model="docTypeInfo.annuityInsuYear">年
								</p>
							</div>
						</div>
					</div>
					<div class="three">
						...
						<div class="choose">
							<div>
								<p>
									<input type="checkbox" v-model="docTypeInfo.fengHong" @change="clickProdcut('fenHong')">
									A 分红保险:您可以每年分红,<b>但红利水平不确定,</b>如果保险公司没赚到钱,可能不分红。
								</p>
								<p>
									<input type="checkbox" v-model="docTypeInfo.wanNeng" @change="clickProdcut('wanNeng')">
									B 万能保险:您可以从所交保险费中拿出一些钱,交给保险公司投资。投资收益率有最低保证, <b>但最低保证以上的收益不确定。</b>您的保险费被扣除一定初始费用和死亡风险保险费后,再交给保险公司投资,在投资过程中还可能定期被扣除一些保单管理费。
								</p>
								<p>
									<input type="checkbox" v-model="docTypeInfo.touLian" @change="clickProdcut('touLian')">
								...
								<p>
									<input type="checkbox" v-model="docTypeInfo.buKanZhong" @change="clickProdcut('touzi')">
									D <b>不看重投资功能</b>
								</p>
							</div>
						</div>
					...
					<div class="four">
						...
						<div class="choose">
							<div>
								<p>
									<input type="checkbox" v-model="docTypeInfo.allPayItem" @change="clickPayItem('all')">
									A 一次性交 
									<input type="text" class="yuan" v-model="docTypeInfo.allPayPrem">元
 								</p>
 								<p>
									<input type="checkbox" v-model="docTypeInfo.periodPayItem" @click="clickPayItem('period')">
									B 每年交
				...
				<div class="content_2">
					...
					<div class="choose">
						<div class="fenxi">
							<p>经分析，建议您购买<input type="text" class="write" v-model="docTypeInfo.riskName">险，保险期间<input type="text" class="write" v-model="docTypeInfo.insuYears">,基本保险金额<input type="text" class="write" v-model="docTypeInfo.amnt" @blur="clearNoNum">。</p>
							<p>交费方式为:
								...
								保险费<input type="text" class="yuan" v-model="docTypeInfo.prem">,
								交费期限<input type="text" class="yuan" v-model="docTypeInfo.payYears1">。
							</p>
						</div>
					</div>
				</div>
				<div class="content_3">
					...
					<p>如果以上问题都是由您本人回答,请在这里签名确认:
						<input type="text" v-model="docTypeInfo.appSign" readonly>
