...
export default [
  {//待办事项
    ...
    name: 'pay',
    path: '/pay/:orderId/:applyCode/:agentCode/:holderName/:idCard',
    meta: {
      login: false,
      hasFooter: false,
      hasTabs: false,
    ...
    name: 'insureResult',
    path: 'insureResult/:isShow/:orderId/:applyCode/:policyCode/:agentCode/:idCard/:holderName/:resultMessage',
    meta: {
      login: false,
      hasFooter: false,
      hasTabs: false,
    ...
    name: 'receipt',
    path: '/receipt/:orderId/:applyCode',
    meta: {
      login: false,
      hasFooter: false,
      hasTabs: false,
    ...
    name: 'bankChange',
    path: '/bankChange/:orderId/:applyCode/:agentCode/:holderName/:idCard',
    meta: {
      login: false,
      hasFooter: false,
      hasTabs: false,
    ...
    name: 'problemShare',
    path: '/problemShare/:orderId/:applyCode/:index/:result/:resultmsg',
    meta: {
      login: false,
      hasFooter: false,
      hasTabs: false,
